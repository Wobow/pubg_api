...
var rx = require('rxjs');
var mapParams = require('./mapParams.js');
...
function PubgApi(apiKey) {
  ...
  */
  this.loadMatches = function () {
    ...
    return _this.wrapAsync(_this.requestAPI(shard, _this.routesURI.matches, mapParams.map(params, mapParams.maps.matches)));
  };
  ...
  * @param {string} shard - The shard id. If not specifed, calls the default shard.
   * @returns A Promise with the result or an error
  */
  this.searchPlayers = function (params) {
    var shard = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this.defaultShard;
    return _this.wrapAsync(_this.requestAPI(shard, _this.routesURI.players, mapParams.map(params, mapParams.maps.players)));
  };
  ...
  * @param {string} shard - The shard id. If not specifed, calls the default shard.
   * @returns A Promise with the result or an error
  */
  this.loadPlayerById = function (playerId) {
    var shard = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this.defaultShard;
    return _this.wrapAsync(_this.requestAPI(shard, _this.routesURI.players + '/' + playerId));
  };
  ...
  map: function map(params, _map) {
    ...
    Object.keys(params).forEach(function (key) {
      if (params[key] !== undefined) {
        computedFilters[_map[key]] = params[key];
      }
    });
